...
export default function Contact() {
  ...
  return <Page>
    <section className="contact-page section-wrap">
      <div className="contact-copy"><Eyebrow>Prendre contact</Eyebrow><h1>Parlons de ce que nous pouvons <span>construire ensemble.</span></h1><p>Tu as un projet, une opportunité ou simplement une question ? Écris-moi. Je te répondrai avec plaisir.</p><div className="contact-details"><div><MapPin /><span><b>Localisation</b>République démocratique du Congo</span></div><a href="mailto:contact@sagelusenge.dev"><Mail /><span><b>Email</b>contact@sagelusenge.dev</span></a><a href="https://github.com/Sagelusenge" target="_blank" rel="noreferrer"><Github /><span><b>GitHub</b>@Sagelusenge</span></a></div></div>
